...
print(clmby.info(memory_usage='deep'))
print(clmby.head())
...
print(cllmemaby_clients.info(memory_usage='deep'))
print(cllmemaby_clients.head())
...
print(daily_calls.head().reset_index())
...
print(clmby['is_missed_call'].value_counts())
...
print(callme_maby_data.head())
print(callme_maby_data.info(memory_usage='deep'))
...
print(efficient_df.info())

print(satisfactory_df.head())
print(satisfactory_df.info())

print(needs_improvement_df.head())
print(needs_improvement_df.info())
